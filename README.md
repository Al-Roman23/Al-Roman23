...
Experienced in building small-to-medium scale web applications using **HTML, CSS, JavaScript, React.js, Next.js, Node.js, Express.js, Firebase, and MongoDB**.  
Passionate about creating scalable, responsive, and user-friendly web applications.

---

## Current Activities
- Developing web apps using **React.js** and **Next.js**.  
